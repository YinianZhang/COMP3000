<template>
  <div>
    <img src="http://localhost:9090/files/orders-b.jpg" style="width: 100%; height: 400px">
    <br>
    <div class="search" style="margin-left: 750px;margin-right: 10px;margin-top: 20px">
      <el-input placeholder="Please enter the order number" style="width: 300px" v-model="orderId"></el-input>
    ...
    <div class="table" style="margin-left: 50px;margin-right: 20px;margin-top: 20px;">
      <el-table :data="tableData" stripe :header-cell-style="{background:'#2A60C9',color:'#fff'}">
        ...
        <el-table-column label="operation" width="180" align="center">
          <template v-slot="scope">
            <el-button    type="primary" @click="changeStatus(scope.row, 'Finished')" size="mini" v-if="scope.row.status === 'WaitingReceipt' && user.role === 'USER'">ConfirmReceipt</el-button>
          </template>
        </el-table-column>
      </el-table>
