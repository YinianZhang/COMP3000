    ...
    <el-dialog title="fosterdata" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false"
      ...
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="days" label="fosterDays">
          <el-input v-model="form.days" autocomplete="off" @change="setPrice"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        days:[
          { required: true, message: 'Please enter the foster days ', trigger: 'blur' },
        ],
      },
    }
  },
  ...
  methods: {
    ...
    handleAdd() {   // add data
      this.form = {
        "status":"WaitingFoster",
        "service":"BasicFoster",
        "days":"1",
        "spend":"30"
      }  // clear data when add new data
